...
INSERT INTO `course` (`courseId`,`nameInEnglish`,`nameInRegional`,`numberOfModelPapers`,`active`) VALUES 
 (1,'Constable',' పోలీస్ కానిస్టేబుల్ ',10,1),
 (2,'SI','సబ్ ఇన్స్పెక్టర్ ',5,1),
 (3,'SSC','ఎస్ ఎస్ సి ',7,1);
...
INSERT INTO `inistitute_courses` (`inistituteId`,`courseId`,`effectieDate`,`expireDate`,`active`) VALUES 
 (1,1,'2018-06-18 00:00:00','2018-07-18 00:00:00',1),
 (1,2,'2018-06-18 00:00:00','2018-07-18 00:00:00',1),
 (1,3,'2018-06-18 00:00:00','2018-07-18 00:00:00',1);
...
INSERT INTO `institute` (`inistituteId`,`NameInEnglish`,`nameInRegional`,`addressId`,`active`) VALUES 
 (1,'Exams Adda','ఎగ్జామ్స్ అడ్డా',NULL,1);
...
INSERT INTO `institute_course_student` (`instituteId`,`courseId`,`studentId`,`active`) VALUES 
 (1,1,'sap.koduri@gmail.com',1),
 (1,1,'sap.koduri@yahoo.com',1),
 (1,2,'sap.koduri@gmail.com',1),
 (1,3,'sap.koduri@yahoo.com',1);
...
INSERT INTO `institute_student` (`instituteId`,`studentId`,`effectiveDate`,`expireDate`,`active`) VALUES 
 (1,'sap.koduri@gmail.com','2018-06-18 00:00:00','2018-06-30 00:00:00',1),
 (1,'sap.koduri@yahoo.com','2018-06-18 00:00:00','2018-06-30 00:00:00',1);
...
CREATE TABLE `option` (
  ...
  `optionImageInEnglish` text NOT NULL,
  `optionImageInRegional` text NOT NULL,
  `active` tinyint(1) NOT NULL DEFAULT '1',
...
CREATE TABLE `question` (
  ...
  `questionImageInEnglish` text NOT NULL,
  `questionImageInRegional` text NOT NULL,
...
CREATE TABLE `user` (
  ...
  `security_answer1` varchar(50) DEFAULT NULL,
  `security_question2` varchar(100) DEFAULT NULL,
  `security_answer2` varchar(50) DEFAULT NULL,
...
INSERT INTO `user` (`emailId`,`password`,`security_question1`,`security_answer1`,`security_question2`,`security_answer2`,`dateOfRegistration`,`lastLogin`,`address`,`active`) VALUES 
 ('sap.koduri@gmail.com','password',NULL,NULL,NULL,NULL,'2018-06-18 00:00:00',NULL,NULL,1),
 ('sap.koduri@yahoo.com','password',NULL,NULL,NULL,NULL,'2018-06-18 00:00:00',NULL,NULL,1);
