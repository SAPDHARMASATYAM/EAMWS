...
//        practicePaper.setPracticePaperId(practicePaperId);
////        practicePaper.setActive(true);
//        practicePaper.setPracticePaperNameInEnglish("Practice Paper : " + practicePaperId);
//        practicePaper.setPracticePaperNameInRegional("అభ్యాస పరీక్ష : " + practicePaperId);
////        practicePaper.setPracticePaperDuration(180);
//        Course course = new Course();
//        course.setCourseId(courseId);
////        practicePaper.setCourse(course);
...
//        for (int i = 1; i <= sectionQuestions.getSection().getNumberOfQuestionsInThisSection(); i++) {
...
//        section.setIsSectionActive(true);
//        section.setSectionDescriptionInEnglish("Section : " + sectionId);
//        section.setSectionDescriptionInRegional("విభాగం : " + sectionId);
//        section.setPracticePaperIdFk(practicePaperId);
...
//        for (int i = 0; i <= questionOptions.getQuestion().get; i++) {
